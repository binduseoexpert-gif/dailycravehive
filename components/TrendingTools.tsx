        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {GOALS.map((goal, i) => (
            <Link
              ...
              className={`goal-card group relative overflow-hidden rounded-2xl bg-gradient-to-br ${goal.bg} p-6 ring-2 ring-transparent transition-all duration-300 hover:-translate-y-1.5 ${goal.glow} ${goal.ring}`}
            >

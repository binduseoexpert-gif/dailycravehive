...
const GOALS = [
  ...
  {
    emoji: "🚩",
    title: "Is This Platform Legit?",
    desc: "Scam checks and honest reviews — verification, payout proof, and real seller complaints.",
    cta: "See All Reviews",
  ...
  {
    emoji: "⚔️",
    title: "I'm Comparing Two Platforms",
    desc: "Head-to-head breakdowns — same criteria, real numbers, clear winner. No bias.",
  ...
  {
    emoji: "📚",
    title: "Pricing, Promotion & Safety",
    desc: "Step-by-step guides — how to price your content, find buyers, and stay anonymous.",
    cta: "See All Guides",
  ...
  return (
    <section className="relative overflow-hidden bg-[#f4f5f8]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="rounded-2xl border-2 border-[#e8505b] p-5">
